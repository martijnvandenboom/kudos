...
return <Layout>
        <div className="h-full flex justify-center items-center flex-col gap-y-4">
            ...
            >{action == 'login' ? 'Register' : 'Login'}</button>

            <h2 className="text-5xl font-extrabold text-white">Welcome to Qstats!</h2>
            <p className="font-semibold text-slate-300">{
            
                action == 'login' ? 'Login to create your alerts!' : 'Register to get started!'
